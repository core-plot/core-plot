...
XCODEBUILDFLAGS="-parallelizeTargets -configuration Release -target CorePlot-CocoaTouch -project ../CorePlot-CocoaTouch.xcodeproj SYMROOT=${PWD}/../../build"

for x_sdk in iphoneos iphonesimulator ; do 
	BASESDK_DIR=Distribution/CorePlotSDK/${x_sdk}.sdk
	xcodebuild $XCODEBUILDFLAGS -sdk ${x_sdk}${SDK_VERSION}
