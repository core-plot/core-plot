...
-(void)changePlotRange
{
    ...
    plotSpace.xRange = [CPTPlotRange plotRangeWithLocation:@0.0 length:@(3.0 + 2.0 * rand() / RAND_MAX)];
    plotSpace.yRange = [CPTPlotRange plotRangeWithLocation:@0.0 length:@(3.0 + 2.0 * rand() / RAND_MAX)];
}
